...
## Zadanie 1
Komunikacja klientów i serwera odbywa się z użyciem protokołu strumieniowego TCP.

## Zadanie 2
Komunikacja klientów i serwera odbywa się z użyciem protokołu datagramowego UDP.
